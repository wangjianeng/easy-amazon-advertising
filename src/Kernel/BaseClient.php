...
//        'FE' => 'https://api.amazon.co.jp/auth/o2/token',
     ...
     */
    public function httpGet(string $url, array $data = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
     ...
     * @date    2019-11-20 10:53
     */
    public function httpPost(string $url, array $data = [], array $query = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
            'Authorization' => 'bearer '.$this->config['accessToken'],
            'Content-Type' => $contentType,
	...
	public function httpPostSBV4(string $url, array $data = [], array $query = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
            'Authorization' => 'bearer '.$this->config['accessToken'],
            'Content-Type' => $contentType,
        ...
        return $this->request($requestUrl.$url, 'POST', ['query' => $query, 'headers' => $headers, 'timeout' => 30]);
    }
     ...
     */
    public function httpPut(string $url, array $data = [], array $query = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
            'Authorization' => 'bearer '.$this->config['accessToken'],
            'Content-Type' => $contentType,
     ...
     * @date    2019-11-20 10:54
     */
    public function httpDelete(string $url, array $data = [], array $query = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
            'Authorization' => 'bearer '.$this->config['accessToken'],
            'Content-Type' => $contentType,
     ...
     */
    public function httpDownload(string $url, array $data = [], $isVersion = true, $contentType='application/json')
    {
        $headers = [
            'Authorization' => 'bearer '.$this->config['accessToken'],
            'Content-Type' => $contentType,
	...
	public function httpDownloadV3(string $url, array $data = [])
    {
        $path_file = $data['path'].'/report/'.date('Y').'/'.date('m').'/'.date('d').'/';
        if (!is_dir($path_file)) {
            mkdir($path_file, 0755, true);
        ...
        $response = $this->client->get($url, ['save_to' => $temp_file, 'timeout' => 120]);
